...
- (id)initWithCenter:(CGPoint)center fileURL:(NSURL*)fileURL withWidth:(CGFloat)width andHeight:(CGFloat)height
{
    self = [super initWithFrame:CGRectZero];
    if (self) {
...
{
    NSMutableArray *frames = [NSMutableArray arrayWithCapacity:7];
    NSMutableArray *delays = [NSMutableArray arrayWithCapacity:7];
...
- (void)startGif
{
    ...
    NSMutableArray *times = [NSMutableArray arrayWithCapacity:7];
